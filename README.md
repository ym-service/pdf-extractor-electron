...
| --- | --- | --- | --- |
| **Lite** | Text extraction only, fast startup, minimal dependencies. | ~70 MB installer | `npm run dist:lite` |
| **Full (OCR)** | Includes EasyOCR + PyTorch binaries, can read rasterised drawings. | 170 MB+ installer | `npm run dist:full` |
